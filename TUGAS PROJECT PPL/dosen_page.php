...
// QUERY GRAFIK
$querygrafik = "SELECT angkatan, SUM(CASE WHEN status_mhs = 'SETUJUI' THEN 1 ELSE 0 END) AS SETUJUI, SUM(CASE WHEN status_mhs = 'BELUM DI SETUJUI' THEN 1 ELSE 0 END) AS BLMSETUJUI FROM tb_profile_user GROUP BY angkatan";
